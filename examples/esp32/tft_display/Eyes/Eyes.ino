...
/**
 * Supported screen is determined by TFT_eSPI configuration: open 'User_Setup.h' in TFT_eSPI library and configure for your screen:
 * See 'Setting up the TFT_eSPI Library': https://dronebotworkshop.com/gc9a01/
 * Example location: /home/dan/snap/arduino/85/Arduino/libraries
 */
